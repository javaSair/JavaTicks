...
public class PanelTopMenu extends JPanel implements MouseListener{
    ...
    void updateCountLabek(){
                ...
                urlJavaTicks.getDirs().createDir();  //заного зполнить список 
    ...
    public PanelTopMenu(JavaTicks urlJavaTicks1) {
        ...
        fonPoppupMessag = new JLabel(new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\search\\Message.png")); // Нужно Изменить иконку
        fonPoppupMessag.setBounds(60, 68, 90, 50);
        fonPoppupMessag.setVisible(false);
        add(fonPoppupMessag, Integer.valueOf(3));
        
        
        fonPoppupMessagNO = new JLabel(new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\search\\MessageNo.png")); // Нужно Изменить иконку
...
// Выпадающая из меню Панель добавления заметки
    ...
    // Кнопка создания заметки
        newAddZametka = new JButton(new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\b1.png"));
 ...
 // Панель открытия существующей заметки  
    ...
    // Кнопка открытия
        openZametka = new JButton(new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\b1.png"));
...
// Инициализировать и добавить в панель кнопки задач
        // кнопка закрытия 
        b1 = new JButton("Выход", new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\b1.png"));
        ...
        b2 = new JButton("История", new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\b1.png"));
        ...
        b3 = new JButton("Опции", new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\b1.png"));
        ...
        b4 = new JButton("редактор", new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\b1.png"));
        ...
        b5 = new JButton("открыть", new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\b1.png"));
        ...
        b6 = new JButton("создать", new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\b1.png"));
        ...
        b7 = new JButton("Домой", new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\b1.png"));
        ...
        listIcon.add(new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\fon.png"));
        listIcon.add(new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\fon1.png"));
        listIcon.add(new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\fon2.png"));
        listIcon.add(new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\fon3.png"));
        listIcon.add(new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\fon4.png"));
        listIcon.add(new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\fon5.png"));
        listIcon.add(new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\fon6.png"));
        listIcon.add(new ImageIcon(urlJavaTicks1.getS()+"src\\image\\Navigation\\fon7.png"));

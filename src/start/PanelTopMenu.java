...
public class PanelTopMenu extends JPanel implements MouseListener{
    ...
    public PanelTopMenu(JavaTicks urlJavaTicks) {
        ...
        fonPoppupMessag = new JLabel(new ImageIcon("src\\image\\Navigation\\search\\Message.png")); // Нужно Изменить иконку
        fonPoppupMessag.setBounds(60, 68, 90, 50);
        fonPoppupMessag.setVisible(false);
        add(fonPoppupMessag, Integer.valueOf(3));
        
        
        fonPoppupMessagNO = new JLabel(new ImageIcon("src\\image\\Navigation\\search\\MessageNo.png")); // Нужно Изменить иконку
